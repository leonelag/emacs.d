...
(defun new-scratch-buffer()
  (interactive)
  (scratch "*scratch*" 'text-mode))

;;
;; Added by Leonel
;;
(defun new-scratch-buffer-text()
  (interactive)
  (scratch "*text-scratch*" 'text-mode))
(defun new-scratch-buffer-lisp()
  (interactive)
  (scratch "*scratch*"))
(defun new-scratch-buffer-clojure()
  (interactive)
  (scratch "*clj-scratch*" 'clojure-mode))
(defun new-scratch-buffer-org()
  (interactive)
  (scratch "*org-scratch*" 'org-mode))

(global-set-key "\C-cs" (make-sparse-keymap))
(global-set-key "\C-csm" 'messages)
(global-set-key "\C-cst" 'new-scratch-buffer-text)
(global-set-key "\C-css" 'new-scratch-buffer)
(global-set-key "\C-csl" 'new-scratch-buffer-lisp)
(global-set-key "\C-csj" 'new-scratch-buffer-clojure)
(global-set-key "\C-cso" 'new-scratch-buffer-org)
